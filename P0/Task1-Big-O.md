There are approximately 5 lines of the code in total will be executed looping over the list of the text messages records in the count_phone_numbers function.
